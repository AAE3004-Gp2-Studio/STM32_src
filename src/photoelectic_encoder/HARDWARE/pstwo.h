...
#define DO_H PDout(3)=1   //Command height //命令位高
#define DO_L PDout(3)=0   //Command low //命令位低

#define CS_H PBout(13)=1  //Cs pull up //CS拉高
#define CS_L PBout(13)=0  //Cs drawdown //CS拉低

#define CLK_H PBout(12)=1 //Clock lift //时钟拉高
#define CLK_L PBout(12)=0 //Clock down //时钟拉低
